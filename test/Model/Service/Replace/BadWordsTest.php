...
class ReplaceBadWordsTest extends TestCase
{
    ...
    public function testReplaceBadWords()
    {
        ...
        $string = 'bitch b*tch batch betcha bltch biach Bi!tches';
        $this->assertSame(
            "$r $r batch betcha $r $r $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'cockadoodledoo cock sucker c0ck';
        $this->assertSame(
            "cockadoodledoo !@#$%^&er $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'rape raped grape therapeutic';
        $this->assertSame(
            "$r {$r}d grape therapeutic",
            $this->replaceBadWordsService->replaceBadWords($string)
        );

        $string = 'shit sh!t sh1t $h!t';
        $this->assertSame(
            "$r $r $r $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
