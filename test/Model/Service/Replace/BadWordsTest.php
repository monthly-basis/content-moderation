...
class ReplaceBadWordsTest extends TestCase
{
    ...
    public function testReplaceBadWords()
    {
        ...
        $string = 'a55h01e dumbass dumbas Dumas method';
        $this->assertSame(
            "$r $r $r Dumas method",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'bit cheerful a b*** a b** Bi**h bit$h';
        $this->assertSame(
            "bit cheerful $r $r $r $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'moby-dick Moby Dick big dik';
        $this->assertSame(
            "moby-dick Moby Dick $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'fuq dafuq MUDERFUQER shut tf up fcking FUUUUUK';
        $this->assertSame(
            "$r da{$r} MUDER{$r}ER $r $r $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );

        $string = 'shut the f up';
        $this->assertSame(
            "$r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'BIG PP my pp small pp academy ppl';
        $this->assertSame(
            "$r $r $r academy ppl",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
