...
class ReplaceBadWordsTest extends TestCase
{
    ...
    public function testReplaceBadWords()
    {
        ...
        $this->assertSame(
            "$r $r asset $r assess {$r}hole as S pass area** $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'moby-dick Moby Dick big dik d i ck đįčķ';
        $this->assertSame(
            "moby-dick Moby Dick $r $r $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'shut the f up F/(k ΔTf/*Kf*i dumb af';
        $this->assertSame(
            "$r $r ΔTf/*Kf*i $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
