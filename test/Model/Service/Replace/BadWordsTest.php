...
class ReplaceBadWordsTest extends TestCase
{
    ...
    public function testReplaceBadWords()
    {
        ...
        $string = 'bitch b*tch batch betcha bltch biach Bi!tches ʙïʨh';
        $this->assertSame(
            "$r $r batch betcha $r $r $r $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'ball suck balls ballsack ballsacks';
        $this->assertSame(
            "ball $r $r $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'd!ck i like dicks DDIICCKK';
        $this->assertSame(
            "$r i like $r $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
