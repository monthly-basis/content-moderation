...
class ReplaceBadWordsTest extends TestCase
{
    ...
    public function testReplaceBadWords()
    {
        ...
        $string = 'suck dick suck a dick d!ck tracy dickhead';
        $this->assertSame(
            "suck $r suck a $r $r tracy $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $this->assertSame(
            "cockadoodledoo $r sucker $r suck a $r $r $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
        ...
        $string = 'fucker fawk fukk Fukkkkkkk';
        $this->assertSame(
            "{$r}er $r $r $r",
            $this->replaceBadWordsService->replaceBadWords($string)
        );
